...
export default function CSVPage() {
  ...
  return (
    <ProtectedPage
      ...
      subject="CSV"
      fallbackMessage="Only administrators and managers can import/export CSV files."
    >
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-xs text-muted-foreground">
                The exported CSV will include all shifts and assignments for the selected location
                and date range.
              </div>
            </CardContent>
          </Card>
